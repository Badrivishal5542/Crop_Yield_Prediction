...
font1 = ('times', 14, 'bold')
upload = Button(main, text="Upload Crop Dataset", command=upload,bg="violet")
...
processButton = Button(main, text="Preprocess Dataset", command=processDataset,bg="violet")
processButton.place(x=700,y=150)
processButton.config(font=font1) 

mlButton = Button(main, text="Train Machine Learning Algorithm", command=trainModel,bg="violet")
mlButton.place(x=700,y=200)
mlButton.config(font=font1) 

predictButton = Button(main, text="Upload Test Data & Predict Yield", command=cropYieldPredict,bg="violet")
predictButton.place(x=700,y=250)
predictButton.config(font=font1)

closeButton = Button(main, text="Close", command=close, bg="violet")
closeButton.place(x=700,y=300)
closeButton.config(font=font1)


font1 = ('times', 12, 'bold')
text=Text(main,height=30,width=80,bg="yellow")
